...
export type LaunchDetailsQuery = (
  ...
  & { launch?: Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'flight_number' | 'mission_name' | 'launch_date_unix' | 'launch_success' | 'upcoming' | 'details'>
    & { rocket?: Maybe<(
      { __typename?: 'LaunchRocket' }
...
export type LaunchListQuery = (
  ...
  & { launches?: Maybe<Array<Maybe<(
    { __typename?: 'Launch' }
    & Pick<Launch, 'flight_number' | 'mission_name' | 'launch_date_unix' | 'launch_success' | 'upcoming'>
    & { rocket?: Maybe<(
      { __typename?: 'LaunchRocket' }
      & Pick<LaunchRocket, 'rocket_name'>
    )>, launch_site?: Maybe<(
...
export const LaunchDetailsDocument = gql`
  ...
  launch(id: $id) {
    ...
    `;
export type LaunchDetailsComponentProps = Omit<ApolloReactComponents.QueryComponentOptions<LaunchDetailsQuery, LaunchDetailsQueryVariables>, 'query'>;

    export const LaunchDetailsComponent = (props: LaunchDetailsComponentProps) => (
      <ApolloReactComponents.Query<LaunchDetailsQuery, LaunchDetailsQueryVariables> query={LaunchDetailsDocument} {...props} />
    );
    
export type LaunchDetailsProps<TChildProps = {}> = ApolloReactHoc.DataProps<LaunchDetailsQuery, LaunchDetailsQueryVariables> & TChildProps;
export function withLaunchDetails<TProps, TChildProps = {}>(operationOptions?: ApolloReactHoc.OperationOption<
  TProps,
  LaunchDetailsQuery,
  LaunchDetailsQueryVariables,
  LaunchDetailsProps<TChildProps>>) {
    return ApolloReactHoc.withQuery<TProps, LaunchDetailsQuery, LaunchDetailsQueryVariables, LaunchDetailsProps<TChildProps>>(LaunchDetailsDocument, {
      alias: 'launchDetails',
      ...operationOptions
    });
};
...
export type LaunchDetailsQueryResult = ApolloReactCommon.QueryResult<LaunchDetailsQuery, LaunchDetailsQueryVariables>;
export const LaunchListDocument = gql`
    query LaunchList($ids: [String], $range: LaunchRange, $limit: Int, $offset: Int, $order: Order, $sort: String) {
  launches(ids: $ids, range: $range, limit: $limit, offset: $offset, order: $order, sort: $sort) {
    flight_number
    mission_name
    launch_date_unix
    rocket {
